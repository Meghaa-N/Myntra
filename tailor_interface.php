                ...
                <nav class="navbar navbar-expand-md bg-dark navbar-dark">
                    ...
                    <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                        ...
                        <div class="navbar-nav mr-auto">
                            ...
                            <a href="cart.php" class="nav-item nav-link">Pending</a>
            ...
            <div class="container-fluid">
               ...
               <!--<div class="row align-items-center product-slider product-slider-4" style="width: 100%;">-->
                <div class="row" style="height: 100%">
                    ...
                    <?php $sql="select * from billing where tailor_id=$_SESSION[tailor];"; 
                    ...
                    <div class="col-lg-3" style="height: 100%">
                        ...
                        <P style="text-align: center;"><button id='<?php echo $row['sno'] ?>' onclick="add_to_cart(this.id)" class="btn">Accept</button>
                        <button id='<?php echo $row['sno'] ?>' onclick="add_to_cart(this.id)" class="btn">Decline</button></P>
